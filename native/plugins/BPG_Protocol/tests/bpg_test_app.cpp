...
int testCase_InterleavedGroups() {
    ...
    BPG::AppPacketGroup group101_def;
    {
        ...
        cv::imencode(image_format, original_image, img_hybrid_data_ptr->binary_bytes, params);
        ...
        report_hybrid_data_ptr->binary_bytes.assign(report_str.begin(), report_str.end());
    ...
    BPG::AppPacketGroup group102_def;
    {
        ...
        done_hybrid_data_ptr->binary_bytes.assign(done_str.begin(), done_str.end());
...
int testCase_SinglePacketGroup() {
    ...
    status_hybrid_data_ptr->binary_bytes.assign(status_str.begin(), status_str.end());
